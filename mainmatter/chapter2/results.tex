...
\newfigure{Fig3.png}{Putative CREs predicted to interact with \emph{FOXA1} promoter}{\textbf{a.} Hi-C conducted in LNCaP cells indicating physical interactions between putative \emph{FOXA1} CREs and the \emph{FOXA1} promoter.}{fig:FOXA1_fig3} % Hi-C resolution is 40 kbp. The six putative FOXA1 CREs are colored in yellow. \textbf{b.} \textbf{c–h.} Zoom-in of each individual putative FOXA1 CRE. C3D value is Pearson correlation of DHS signal between LNCaP and the DHS reference matrix.}{fig:FOXA1_fig3}
