...
Here, we use targeted genome sequencing, \gls{rnaseq}, \gls{atacseq}, and bisulfite sequencing of patient-matched samples with \glsentrylongpl{pdx} to investigate the dynamics of the genome and epigenome over \gls{ball} relapse.
