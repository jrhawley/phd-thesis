...
\subsection{\Glsentrylong{pdx} generation and \glsfmtlongpl{lda}}
...
\subsection{Human cell isolation from \glsfmtlongpl{pdx}}
...
\subsection{Primary and \glsfmtlong{pdx} sample sequencing}
