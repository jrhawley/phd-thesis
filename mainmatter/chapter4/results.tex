...
However, if we treat the estimates for $\Beta_0$ and $\Sigma$ derived from the \gls{wt} samples as known inputs for the mutated model, then \Cref{eqn:single_mut_model} for a single mutated sample meets the criteria for the \gls{js} estimators.
