...
\begin{itemize}
  ...
  \item Almost all of the \glspl{sv} in the prostate tumours in \Cref{chap:3D} were unique to a single patient, reducing the statistical power when testing for differentially expressed genes around \gls{sv} breakpoints
\end{itemize}
