...
Methylation of gene promoter regions is associated with reduced gene expression and loss of \gls{dname} (hypomethylation) across the genome and focal increases of \gls{dname} (hypermethylation) have been found across numerous cancers \cite{jonesFundamentalRoleEpigenetic2002,feinbergHistoryCancerEpigenetics2004}.
