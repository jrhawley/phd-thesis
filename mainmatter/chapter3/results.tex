...
Here, we optimized and conducted low-input Hi-C \cite{diazChromatinConformationAnalysis2018} on 10 $\mu$m thick cryosections from 12 primary prostate tumours and 5 primary benign prostate sections (see Methods, \Cref{fig:3D_fig1}a, Supplementary Figure 1a).
...
For example, chromatin around the AR gene that was previously found enriched in the 22Rv1 compared to RWPE1 prostate cell lines \cite{rhieHighresolution3DEpigenomic2019} were not recapitulated in either benign or tumour primary samples (\Cref{fig:3D_fig1}d, Supplementary Figure 1d).
...
16,474 unique chromatin interactions were identified in at least one sample (\Cref{fig:3D_fig2}a), reaching an estimated \\textapprox 80\% saturation of detection (Supplementary Figure 3c).
