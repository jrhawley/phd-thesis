...
Nonetheless, we identify changes to focal chromatin interactions and show how \glsentrylongpl{sv} can induce these changes to guide \glsentrylong{cre} hijacking.
Such events result in opposing differential expression on genes found at antipodes of rearrangements.
Collectively, our results argue that \glsentrylong{cre} hijacking from \glsentrylong{sv}-induced altered focal chromatin interactions overshadows higher-order topological changes in the development of primary \glsentrylong{pca}.
